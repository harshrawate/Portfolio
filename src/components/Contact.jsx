                ...
                <div className='flex justify-center items-center'>
                    ...
                    >
                        <input
                            ...
                            className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none border-cyan-400'
                        />
                        <input
                            type="email"
                            name="email"
                        ...
                        <textarea
                            ...
                            className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none border-cyan-400 '
                        />
                        <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 mx-auto rounded-md hover:scale-110 duration-300 '>
                            Let's Talk
                        </button>
                    </form>
                </div>
